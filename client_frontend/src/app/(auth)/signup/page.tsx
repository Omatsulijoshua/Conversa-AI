...
import { Mic2, Mail, Lock, User, ArrowRight, Loader2 } from 'lucide-react';
...
export default function SignupPage() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || 'https://conversa-backend-6bou.onrender.com/api/v1'}/auth/register`, {
        method: 'POST',
      ...
      <div className="w-full max-w-md animate-fade-in">
        ...
        <div className="glass-card p-8 rounded-3xl border border-white/10 bg-white/5 backdrop-blur-xl shadow-2xl">
          <div className="mb-8 text-center">
            ...
            <p className="text-slate-400">Start building with Conversa AI today</p>
          </div>
